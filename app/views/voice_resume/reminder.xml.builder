...
xml.Response do
  xml.Gather(:action => @post_to, :numDigits => 1) do
    ...
    xml.Say "Please press 1 to repeat this menu. Press 2 to know Amay's professional qualification. Press 3 to know Amay's educational qualification. Press 4 to know why Amay is a good fit for Twilio. Press 5 to know Amay's contact information. Press 6 to hang up and call Amay for an interview."
  end
end
